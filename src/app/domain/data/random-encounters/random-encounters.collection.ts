...
export const RandomEncountersCollection: RandomEncounterEntityState = {
  ids: ['beastmen50', 'beastmen75', 'beastmen100', 'orcs50', 'highelves50', 'goblins75', 'volcanodwarfs75'],
  entities: {
    'beastmen50': {
      id: 'beastmen50',
    ...
    'orcs50': {
      ...
      flavour: 'A band of orc raiders blocks your path, their eyes gleaming with the promise of a fight.',
      tiles: [TileType.ANY],
    ...
    'highelves50': {
      ...
      flavour: 'A group of high elves stands in your way, their eyes scanning the horizon for threats.',
      tiles: [TileType.ANY],
      faction: Faction.HighElves,
      points: 50,
      roster: [
    ...
    'goblins75': {
      ...
      flavour: 'A group of goblins jumps out from behind the bushes, brandishing their weapons and shouting insults.',
      tiles: [TileType.ANY],
    ...
    'volcanodwarfs75': {
      ...
      flavour: 'A group of volcanic dwarfs emerges from the shadows, their eyes glowing with the heat of the volcano.',
      tiles: [TileType.ANY],
      faction: Faction.VolcanicDwarfs,
      points: 75,
      roster: [
